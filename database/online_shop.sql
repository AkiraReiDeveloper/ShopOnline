...
--
-- Servidor: localhost
-- Tiempo de generación: 05-11-2019 a las 16:48:36
...
INSERT INTO `clientes` (`id`, `usuario`, `nombre`, `apellido`, `correo`, `contrasena`, `token`) VALUES
(1, 'ElKarlos69', 'Carlos', 'Alonso', 'juan_ps@gmoil.me', 'gfhdrfghfgm', ''),
(2, 'ElKarlos690', 'Carlos', 'Alonso', 'juan_ps@gmoil.me', 'lkbzdgq3rh.', ''),
(3, 'Lokos34', 'fdgsdg', 'dfgsdfg', 'fdghdfg@dfds.com', '1234', ''),
(4, 'Folagor02', 'fdgsdg', 'dfgsdfg', 'fdghdfg@dfds.com', '4feb2371a1843d099b28dd419dbab1ef', ''),
(5, 'AkiraReiGamer', 'Akira', 'Reyes', 'vmrg241096@gmail.com', 'da13fe07a8882019b0cacc144a53d9d7', ''),
(6, 'AkiraReyes', 'VICTOR MANUEL', 'REYES', 'vmrg241096@gmail.com', 'a14fc97a083cc9250089460bdc9bc37e', '');
...
INSERT INTO `productos` (`id_productos`, `nombre`, `precio`, `cantidad`, `img`, `descripcion-corta`, `descripcion`, `categoria`) VALUES
(1, 'Balon de futbol Adidas Startlancer V.', 337, 10, 'imagenes/productos/balon.jpg', 'Balon de fulbol con calcomania de adidas, color rosa', 'Balon de fulbol con calcomania de adidas, color rosa de uso exclusivo profesional, soporte de humedad, union con costuras', 3),
...
(10, 'Android', 2000, 46, 'imagenes/productos/android.png', 'Libro basico de android', 'Libro basico para aprender a programar en dispositivos con sistema operativo android', 4),
